...
// ============================================================================
// VENDORED from lib/uniswap-hooks/lib/v4-periphery/src/V4Router.sol.
// This is the contract Uniswap's UniversalRouter inherits to dispatch v4 actions.
// The spike drives THIS, not a paraphrase of it.
//
// NINE LINES DIFFER FROM UPSTREAM, ALL MECHANICAL:
//   1x pragma  : `0.8.26` (exact) -> `^0.8.26`. This repo pins solc 0.8.30 because src/
//                uses the `transient` keyword (needs >=0.8.28); an exact 0.8.26 pin cannot
//                be compiled in the same project.
//   8x import  : `"./x.sol"` -> `"@uniswap/v4-periphery/src/x.sol"`. Same files, resolved
//                through the remapping because the copy no longer sits in src/.
// Zero lines of logic differ. Verify:
//   diff <(tail -n +17 test/spike/vendor/V4Router_vendored.sol) \
//        <(tail -n +2 lib/uniswap-hooks/lib/v4-periphery/src/V4Router.sol)
// ============================================================================
